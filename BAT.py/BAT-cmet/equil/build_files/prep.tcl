...
set filini equil-lig-ini.pdb
set filpdb equil-lig.pdb
set n 0
set rad 100
set xd 2.38 
set yd 1.75 
...
set pr [atomselect 0 "(not resname LIG) and (resid 1 to 109 and name CA C N O)"]
set all [atomselect 0 "(resid 1 to 109 and not water and not resname LIG and noh) or (resname LIG) or (resname  WAT)"]
...
set lig [atomselect 1 "resname LIG"]
set ligh [atomselect 1 "resname LIG and noh"]
$lig set chain S
$lig set resid 1
$lig writepdb lig.pdb
$ligh writepdb lig-noh.pdb

set a [atomselect 1 "resname LIG and noh"]
set tot [$a get name]

foreach i $tot {
set t [atomselect 1 "resname LIG and name $i"]
set p [atomselect 1 "(not resname LIG) and (resid 77 and name CA)"]
...
set angle {}
set t [atomselect 1 "resname LIG and name $i"]
set p [atomselect 1 "resname LIG and name $aa1"]
set d [atomselect 1 "(not resname LIG) and (resid 77 and name CA)"]
...
set angle {}
set t [atomselect 1 "resname LIG and name $i"]
set p [atomselect 1 "resname LIG and name $aa2"]
set d [atomselect 1 "resname LIG and name $aa1"]
...
set a [atomselect 1 "(not resname LIG) and (resid 1 to 109 and name CA C N O)"]
set b [atomselect 1 "resname LIG and noh"]
